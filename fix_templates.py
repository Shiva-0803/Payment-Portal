...
admin_content = """{% extends 'base.html' %}
...
<div class="card wide">
    ...
    <div class="filter-section" style="margin: 20px 0; padding: 15px; background: #f8f9fa; border-radius: 8px;">
        <form method="get" action="." style="display: flex; gap: 15px; align-items: flex-end;">
            ...
            <button type="submit" class="btn" style="height: 38px;">Filter</button>
            <a href="{% url 'admin_dashboard' %}" class="btn"
                style="background: #e74c3c; line-height:38px; display:inline-block; height:38px; text-decoration:none;">Reset</a>
            <button type="button" onclick="window.print()" class="btn"
                style="background: #34495e; height: 38px; cursor: pointer; border: none; color: white; padding: 0 15px; border-radius: 4px;">Print
                List</button>
        </form>
    </div>
...
exam_content = """{% extends 'base.html' %}
        ...
        <div class="filter-section" style="margin: 20px 0; padding: 15px; background: #f8f9fa; border-radius: 8px;">
            <form method="get" action="." style="display: flex; gap: 15px; align-items: flex-end;">
                ...
                <a href="{% url 'exam_dashboard' %}" class="btn"
                    style="background: #e74c3c; line-height:38px; display:inline-block; height:38px; text-decoration:none;">Reset</a>
                <button type="button" onclick="window.print()" class="btn"
                    style="background: #34495e; height: 38px; cursor: pointer;">Print List</button>
            </form>
        </div>
...
with open('d:/0803/users/templates/users/admin_dashboard.html', 'w', encoding='utf-8') as f:
    f.write(admin_content)
    print("Updated admin_dashboard.html")

with open('d:/0803/users/templates/users/exam_dashboard.html', 'w', encoding='utf-8') as f:
    f.write(exam_content)
    print("Updated exam_dashboard.html")
