...
CSRF_TRUSTED_ORIGINS = [
    ...
    'https://payment-portal-xjgc.onrender.com',
]

# Tell Django it's secure if Render forwards HTTPS
...
EMAIL_TIMEOUT = 5  # Prevent Gunicorn worker from being killed on Render if SMTP hangs
